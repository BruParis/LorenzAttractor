...
void updatePoint(cv::Point3f& point, float time_delta, float sigma, float rho,
    float beta)
{
...
int main()
{
    ...
    while(!myWindow.wasStopped())
    {
        ...
        viz::WCloud cloud_widget = cv::viz::WCloud( points, cv::viz::Color::green() );
